"""Точка входа place-catalog (справочник городов)."""
...
from python.place_catalog.src.place_catalog.app import PlaceCatalogApp  # noqa: E402


def main() -> None:
    app = injector().inject(PlaceCatalogApp)
    app.run()
