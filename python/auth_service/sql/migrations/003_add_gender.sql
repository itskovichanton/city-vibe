...
BEGIN
    ...
    ELSIF EXISTS (
        ...
        ALTER TABLE accounts ALTER COLUMN gender DROP DEFAULT;
        ALTER TABLE accounts
        ...
        ALTER TABLE accounts ALTER COLUMN gender SET DEFAULT 'male'::gender;
        ALTER TABLE accounts ALTER COLUMN gender SET NOT NULL;
    END IF;
END $$;
