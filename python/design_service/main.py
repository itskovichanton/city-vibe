"""Точка входа design-service (пины карты, темы чатов)."""
...
from python.design_service.src.design_service.app import DesignServiceApp  # noqa: E402


def main() -> None:
    app = injector().inject(DesignServiceApp)
    app.run()
