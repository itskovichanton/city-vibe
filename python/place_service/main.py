"""Точка входа place-service (справочник городов)."""
...
from python.place_service.src.place_service.app import PlaceServiceApp  # noqa: E402


def main() -> None:
    app = injector().inject(PlaceServiceApp)
    app.run()
